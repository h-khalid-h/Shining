...
/**
 * Modal wrapper for DecisionHistory component
 * Shows decision timeline and tracking
 */
export function DecisionHistoryModal({ northId, onClose, visible }: DecisionHistoryModalProps) {
    if (!northId) return null;
                        ...
                        <div className="bg-bolt-elements-background-depth-1 rounded-lg shadow-2xl border border-bolt-elements-borderColor">
                            ...
                            <div className="flex items-center justify-between p-4 border-b border-bolt-elements-borderColor">
                                <div className="flex items-center gap-2">
                                    <div className="i-ph:path text-2xl text-bolt-elements-textPrimary" />
                            ...
                            <div className="overflow-y-auto max-h-[calc(80vh-4rem)]">
                                <DecisionHistory northId={northId} />
                            </div>
                        </div>
                    </motion.div>
                </>
