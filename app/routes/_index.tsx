  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div className="flex-1 flex overflow-hidden">
        {isClient ? (
          <WorkbenchLayout userId={userId ?? null} messageCount={messageCount} setMessageCount={setMessageCount} />
        ) : (
...
// Separate component to use stores (client-side only)
    ...
    <>
      {showChat && (
        <div className="flex-1 relative">
          ...
          <IntelligenceLayerClient userId={userId} messageCount={messageCount} />
        </div>
      )}
      {showWorkbench && (
      ...
      {!showChat && !showWorkbench && (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">Click Chat or Code in the header to get started</p>
          </div>
        </div>
      )}
    </>
